...
let AuthService = (() => {
    ...
    var AuthService = _classThis = class {
        constructor(prisma, configService, userRepository) {
            this.prisma = prisma;
        ...
        async create(createAuthDto) {
            ...
            const refreshToken = refreshTokenExpired({ id: userExist.id, email: userExist.email }, this.configService);
            const accessToken = generateToken({ id: userExist.id, email: userExist.email }, this.configService);
            return {
                success: true,
